...
<head>
    ...
    <title>Perfil de <?php echo htmlspecialchars($username); ?> - ValoLine</title>
            ...
            <div class="contenedor-perfil">
                <div class="portada-perfil" style="background-image: url('http://localhost/multimedia/relleno/fondo-9.png');">
                    ...
                    <div class="datos-perfil">
                        <h4 class="titulo-usuario">Hola, <?php echo htmlspecialchars($username); ?></h4>
                    </div>
                ...
                <div class="menu-perfil">
                    <ul>
                        <li><a href="informacion-perfil.php" title=""><i class="icono-perfil fas fa-info-circle"></i> Informacion</a></li>
